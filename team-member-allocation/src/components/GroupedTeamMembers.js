...
const GroupedTeamMembers = ({employees, selectedTeam, setTeam}) => {
    ...
    {
        let transformedEmployeesGroupData = groupedEmployees.map( (groupedData)=> groupedData.team === event.currentTarget.id?{...groupedData, collapsed: !groupedData. collapsed} : groupedData);
        setGroupedData(transformedEmployeesGroupData);
